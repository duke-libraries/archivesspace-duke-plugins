...
AppConfig[:plugins] = ['local',  'aspace-public-formats', 'aspace-search-identifier', 'lcnaf', 'duke-ead-exporter', 'duke-advanced-search', 'duke-export-option-defaults', 'archivesspace-delete-safety-plugin', 'user_defined_in_basic']
